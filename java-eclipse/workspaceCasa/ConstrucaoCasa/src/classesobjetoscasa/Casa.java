...
public class Casa {
	...
	//Aramazenando o valor recebidp para a descrição e status da(s) porta(s) da casa
	public List<Porta> getListaDePortas(){
		return this.listaDePortas;
	}
	//Recebe o valor enviado para a descrição e status da(s) porta(s) da casa
	public void setListaDePortas(List<Porta> listaDePortas){
		this.listaDePortas = listaDePortas;
	}
	//Aramazenando o valor recebidp para a descrição e status da(s) janela(s) da casa
	public List<Janela> getListaDeJanelas() {
		return this.listaDeJanelas;
	}
	//Recebe o valor enviado para a descrição e status da(s) janela(s) da casa
	public void setListaDeJanelas(List<Janela> listaDeJanelas) {
		this.listaDeJanelas = listaDeJanelas;
	}
	/*
	 * O método construirCasa() está preparado para receber a lista de Janelas(descrição,status),
	 * lista de portas(descrição,status), cor e descrição da casa. Observe que após receber os
	 * valores da casa, estes são repassadas para os seus respectivos métodos de armazenamento,
	...
	/*
	 * O método abaixo recebe a cor informada pelo usuário e na aeguemcia
	...
	public void movimentarPorta(int index, int status) {
		...
		listaDePortas.set(index, porta);   //Não é necessario
	}
	...
	public void movimentarJanela(int index, int status) {
		...
		listaDeJanelas.set(index, janela);  //Não é necessario
		 */
	}
	
}//Término da classe Casa
